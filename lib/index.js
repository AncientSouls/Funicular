...
this._parents={};this.data=undefined}/**
   ...
   * @param {Carriage~unmountCallback} [callback]
   */},{key:'unmount',value:function unmount(callback){var _this2=this;if(Object.keys(this._parents).length===0){this.unmountChilds(function(){_this2.unsafeUnmount(callback)})}else if(typeof callback=='function'){callback()}}/**
