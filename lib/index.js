...
this._parents={};this.data=undefined;this.roots=[];this.unmountedCallbacks=[];this.mountedCallbacks=[]}/**
   ...
   */},{key:'getChildsNames',value:function getChildsNames(callback){throw new Error('Method getChildsNames must be overriden!')}/**
...
this.roots={}}/**
   ...
   */_createClass(Funicular,[{key:'mount',value:function mount(name,mountedCallback,unmountedCallback){var carriage=new this.Carriage(name);var mountedCallback=mountedCallback||function(error){throw error};if(mountedCallback)carriage.mountedCallbacks.push(mountedCallback);if(unmountedCallback)carriage.unmountedCallbacks.push(unmountedCallback);carriage.mount()}/**
