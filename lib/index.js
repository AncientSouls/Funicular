 ...
 */var Item=function(){/**
   ...
   * @param {Item} child
   */_createClass(Item,[{key:'set',value:function set(name,child){if(!isItem(child))throw new Error('child '+child+' must be a Item instance.');if(typeof name=='string'){this.childs[name]=child;child.parents[this.index]=new Parent(name,this)}else{child.parents[this.index]=new Parent(null,this)}}/**
