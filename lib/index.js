...
this._parents={};this.data=undefined}/**
   ...
   * Attention! Not for personal usage.
   * @param {Carriage~unmountCallback} [callback]
   */},{key:'unmount',value:function unmount(callback){var _this2=this;if(this.state!='unmounted'&&this.state!='broken'&&Object.keys(this._parents).length===0&&!this.funicular.roots[this.id]){this.unmountChilds(function(){_this2.unsafeUnmount(callback)})}else if(typeof callback=='function'){callback()}}/**
   ...
   * @param {Carriage} child
   */},{key:'untieChild',value:function untieChild(child){delete this._childs[child.name];delete child._parents[this.name]}}]);return Carriage}();/**
 * @example
 ...
 */var Funicular=function(){function Funicular(){_classCallCheck(this,Funicular);var funicular=this;this.Carriage=function(_Carriage){_inherits(_class,_Carriage);function _class(){_classCallCheck(this,_class);var _this5=_possibleConstructorReturn(this,(_class.__proto__||Object.getPrototypeOf(_class)).apply(this,arguments));_this5.funicular=funicular;_this5.id=++_this5.funicular.lastId;funicular.carriages[_this5.name]=funicular.carriages[_this5.name]||{};funicular.carriages[_this5.name][_this5.id]=_this5;return _this5}return _class}(Carriage);this.lastId=0;// { name: { id: Carriage, id: Carriage }, name: { id: Carriage, id: Carriage }, name: { id: Carriage, id: Carriage } }
...
this.roots={}}/**
   ...
   */},{key:'mountRoot',value:function mountRoot(name,callback){var _this6=this;this.mount(name,function(error,carriage){if(!error)_this6.roots[carriage.id]=carriage;var unmountRoot=function unmountRoot(callback){delete _this6.roots[carriage.id];carriage.unmount(callback)};callback(error,carriage,unmountRoot)})}/**
